...
<html lang="{$core.language.iso}" dir="{$core.language.direction}">
	...
	<body class="page page-{$core.page.name}">
		<div class="body">
			<div class="inv">
				<div class="container">
			...
			<header class="header{if 'index' != $core.page.name} header--inner{/if}"{if $core.config.website_bg} style="background-image: url('{$smarty.const.IA_URL}uploads/{$core.config.website_bg}');"{/if}>
					...
					<div class="container">
						...
						<div class="collapse navbar-collapse" id="navbar-collapse">
							<ul class="nav navbar-nav navbar-right nav-main">
								<li><a href="{$smarty.const.IA_URL}favorites/"><span class="fa fa-star text-warning"></span> {lang key='wishlist'}</a></li>
					...
					<div class="sec-landing__wrp">
						<div class="sec-landing__nav">
							<ul class="nav nav-pills">
								...
								<li><a href="#tab-bodystyle" data-toggle="tab">{lang key='tab_bodystyle'}</a></li>
							</ul>
						</div>
						<div class="tab-content">
							...
							<div class="tab-pane" id="tab-bodystyle">
